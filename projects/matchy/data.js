...
//////////////////////////////////////////////////////////////////////
var noises = [];
noises[noises.push('hiss')]
noises.push("bite");
noises.unshift("rattle");
noises[noises.push('slither')];
...
animals.push(duck);
console.log(animals);
var fox = { species: 'foxy', name: 'foxalina', noises: ['ye, ye, ye, ye', ' ', 'what dose the fox say', 'howll'] };
animals.push(fox)
